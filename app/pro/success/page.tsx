    ...
    <div className="min-h-screen bg-[#fef7f0] flex items-center justify-center">
      <div className="max-w-md mx-auto px-4 text-center">
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <h1 className="text-2xl font-bold text-[#2d2235] mb-2">
            Welcome to Pro!
          </h1>
          ...
          {sessionId && (
            <p className="text-xs text-[#9889a8] mb-4">
          ...
          <div className="space-y-3">
            <Link
              href="/#generator"
              className="block w-full bg-[#7c3aed] text-white py-3 px-4 rounded-lg font-semibold hover:bg-[#6d28d9] transition-colors"
            >
              Start Creating Pro Worksheets
            </Link>
            <Link
              href="/"
              className="block text-sm text-[#9889a8] hover:text-[#6b5b7b] transition-colors"
            >
              Back to Home
            </Link>
          </div>
        ...
        <div className="mt-6 bg-white rounded-xl shadow p-6 text-left">
          <h2 className="font-semibold text-[#2d2235] mb-3 text-sm">
            Your Pro Features
          </h2>
          <ul className="space-y-2 text-sm text-[#6b5b7b]">
...
export default function ProSuccessPage() {
  return (
    <Suspense
      fallback={
        <div className="min-h-screen bg-[#fef7f0] flex items-center justify-center">
          <div className="text-[#9889a8]">Loading...</div>
        </div>
      }
    >
      <SuccessContent />
